...
import { Component, ElementRef, OnInit, ViewChild, ViewEncapsulation, ChangeDetectorRef, AfterViewChecked } from '@angular/core';
...
@Component({
    ...
    animations   : [trigger('EnterLeave1', [
...
export class GeneratedIndentList implements OnInit
{
    ...
    get(){
        ...
        var csv =[];
         ...
         console.log(this.dataSource[i].PODate,this.dataSource[i].PONumber,this.dataSource[i].Quantity)
         this.someData = 
             {   

                PODate: this.dataSource[i].PODate, 
                PONumber: this.dataSource[i].PONumber, 
                VendorName: this.dataSource[i].VendorName,
                SupplierRef: this.dataSource[i].SupplierRef,
                TermsofDelivery: this.dataSource[i].TermsofDelivery,
                Despatchhrough: this.dataSource[i].Despatchhrough
    ...
    convert(){
        ...
        console.log(item.push(this.dataSource))
        var doc = new jsPDF();
