...
@Component({
  selector: 'mould-history-modal',
  styleUrls: ['./mould-history.component.scss'],
  templateUrl: './mould-history.component.html',
  animations   : fuseAnimations,
})
export class MouldHistoryComponent implements OnInit {
    public moment = moment;

    @Input() dataSource: any[] = [];
    displayedColumns = ['serial', 'date', 'number', 'Moulding', 'qty' ,'name', 'category',];
    someData:any;;
    final=[];
    // Private
  ...
  downloadCSV() {
      ...
      filename = 'mouldhistory-list.csv';
