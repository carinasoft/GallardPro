...
@Component({
  selector: 'planned-history-modal',
  styleUrls: ['./planned-history.component.scss'],
  templateUrl: './planned-history.component.html',
  animations   : fuseAnimations,
})
export class PlannedHistoryComponent implements OnInit {
