...
{        MouildNo: 'A2032', 
         WordOrderNo: '681', 
         ClientPONo: 'SINHA TRIAL ORDER', 
         ClientName: 'Porwal Auto Components Ltd',
         DateOfMoulding: '10/04/2019', 
         Contractor: 'Banwari', 
         Product: 'Pacl Suspension Tube Fuji 4303', 
         Weight: '2.0'},
         {        MouildNo: 'A2032', 
         WordOrderNo: '681', 
         ClientPONo: 'VERBAL', 
         ClientName: 'Alert Engg',
         DateOfMoulding: '10/04/2019', 
         Contractor: 'Banwari', 
         Product: 'Pot-1013', 
         Weight: '2.0'},
...
@Component({
    selector     : 'PouringPending',
    templateUrl  : './PouringPending.component.html',
    styleUrls    : ['./PouringPending.component.scss'],
    animations   : fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class PouringPendingComponent implements OnInit
{    
    @Input() refreshList = false;
    @Input() disabled = true;
    dataSource = ELEMENT_DATA;
   displayedColumns = [ 'MouildNo', 'WordOrderNo', 'ClientPONo','ClientName','DateOfMoulding','Contractor','Product','Weight','view','action'];
