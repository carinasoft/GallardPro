...
@Component({
    selector     : 'producation-list',
    templateUrl  : './producation-list.component.html',
    styleUrls    : ['./producation-list.component.scss'],
    animations   : fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class ProducationlistComponent implements OnInit
{    
