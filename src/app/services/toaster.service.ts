...
import { APP_DEFAULT_TITLE, DEFAULT_TOASTER_OPTIONS ,myDEFAULT_TOASTER_OPTIONS } from '../app.constant';
...
export class ToasterService {
  ...
  public mywarningToast(msg: string, title: string = APP_DEFAULT_TITLE): void {
    this._toaster.warning(msg, title, Object.assign({}, myDEFAULT_TOASTER_OPTIONS));
  }
